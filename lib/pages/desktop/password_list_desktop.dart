  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<MasterPasswordNotifier, SaltNotifier>(
        ...
        return salt != null && masterPassword != null
            ? Row(
                children: [
                  Container(
                      width: 400,
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          RichText(
                            text: TextSpan(children: [
                              TextSpan(
                                  text: 'Bentornato, ',
                                  style: TextStyle(
                                      color: receiveDarkMode(true), fontSize: 16, fontWeight: FontWeight.w400)),
                              ...
                              TextSpan(
                                  ...
                                  style: TextStyle(
                                      color: receiveDarkMode(true), fontSize: 24, fontWeight: FontWeight.w600))
                            ]),
                          ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Nuove password',
                                    style: TextStyle(
                                        color: Colors.grey.shade100, fontSize: 18, fontWeight: FontWeight.w600),
                                  ),
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        color: Colors.grey.shade300, fontSize: 14, fontWeight: FontWeight.w400),
                                  ),
                          ...
                          StreamBuilder(
                              stream: SupaBase().getSearchedPasswords('passwords', '', masterPassword, salt),
                                      ...
                                      for (var category in passCategories)
                                        Padding(
                                          ...
                                          child: HomepageTile(
                                              ...
                                              onTap: () => setState(() {
                                                    categoryFilter =
                                                        EncryptionHelper().decryptData(category, masterPassword, salt);
                                                  }),
                          ...
                          CustomButton(
                              ...
                              onPressed: () {
                                masterPasswordNotifier.deleteMasterPassword();
                                SupaBase().signOut();
                              },
                              child: Text('Logout'))
                        ]),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: StreamBuilder(
                                stream:
                                    SupaBase().getSearchedPasswords('passwords', _searchBar.text, masterPassword, salt),
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                      ...
                                      itemBuilder: (context, passwordsIndex) {
                                        ...
                                        final decryptedPassword = Passwords(
                                            id: password.id,
                                            provider:
                                                EncryptionHelper().decryptData(password.provider, masterPassword, salt),
                                            username:
                                                EncryptionHelper().decryptData(password.username, masterPassword, salt),
                                            password:
                                                EncryptionHelper().decryptData(password.password, masterPassword, salt),
                                            notes: EncryptionHelper().decryptData(password.notes, masterPassword, salt),
                                            category:
                                                EncryptionHelper().decryptData(password.category, masterPassword, salt),
