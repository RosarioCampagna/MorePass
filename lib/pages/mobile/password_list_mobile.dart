...
class _PasswordListMobileState extends State<PasswordListMobile> {
  ...
  List<Passwords> filterByCategory(List<Passwords> psw, passedMasterPassword, passedSalt) {
    if (categoryFilter != 'Tutto') {
      psw = psw
          .where((password) =>
              EncryptionHelper().decryptData(password.category, passedMasterPassword, passedSalt) == categoryFilter)
          .toList();
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          backgroundColor: receiveDarkMode(false),
          actions: [IconButton(onPressed: () => Navigator.pop(context), icon: Icon(Icons.close_rounded))],
        ),
        ...
        bottomNavigationBar: NavBar(
          items: [
            ...
            NavbarComponent(
                ...
                label: 'Home',
                onTap: () =>
                    Navigator.pushAndRemoveUntil(context, slideRightNavigator(const AUthGate()), (_) => false)),

            //nav bar della pagina corrente
            NavbarComponent(icon: Icons.key_rounded, selected: true, label: 'Vault'),
            ...
            NavbarComponent(
                ...
                onTap: () => Navigator.pushAndRemoveUntil(
                    context, slideLeftNavigator(const PasswordGeneratorPage()), (_) => false)),
            ...
            NavbarComponent(
                ...
                label: 'Impostazioni',
                onTap: () =>
                    Navigator.pushAndRemoveUntil(context, slideLeftNavigator(const SettingsPage()), (_) => false)),
          ],
        ),
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          CustomRadioButton(
                                              ...
                                              onChanged: (value) => setAlertState(() {
                                                    alertSorting = value!;
                                                  }),
                                              child: Text('Provider',
                                                  style: TextStyle(
                                                      color: receiveDarkMode(true), fontWeight: FontWeight.w600))),
                                  ...
                                  actions: [
                                    ...
                                    TextButton(
                                        onPressed: () => setState(() {
                                              ...
                                              categoryFilter = alertCategoryFilter;
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(sorting, style: TextStyle(color: receiveDarkMode(true), fontSize: 18)),

                            //categoria
                            Text(' ($categoryFilter)', style: TextStyle(color: receiveDarkMode(true), fontSize: 18)),
                  ...
                  Expanded(
                    child: StreamBuilder(
                        stream: SupaBase().getSearchedPasswords('passwords', _searchBar.text, masterPassword, salt),
                        builder: (context, snapshot) {
                          ...
                          if (widget.category != null || categoryFilter != 'Tutto') {
                            passwords = filterByCategory(passwords, masterPassword, salt);
                          }
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, passwordsIndex) {
                                ...
                                final decryptedPassword = Passwords(
                                    id: password.id,
                                    provider: EncryptionHelper().decryptData(password.provider, masterPassword, salt),
                                    username: EncryptionHelper().decryptData(password.username, masterPassword, salt),
                                    password: EncryptionHelper().decryptData(password.password, masterPassword, salt),
                                    notes: EncryptionHelper().decryptData(password.notes, masterPassword, salt),
                                    category: EncryptionHelper().decryptData(password.category, masterPassword, salt),
